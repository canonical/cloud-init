...
def advertise_supported_events(supported_update_events, rpctool, rpctool_fn):
    ...
    advertised_event_scopes_and_types_list = []
    for event_scope in supported_update_events:
        ...
        advertised_event_scopes_and_types_list.append(event_scope_and_types)

    if len(advertised_event_scopes_and_types_list) > 0:
        advertised_event_scopes_and_types_list.sort()
        advertised_event_scopes_and_types_string = ",".join(
            advertised_event_scopes_and_types_list
        )
        guestinfo_set_value(
            SUPPORTED_UPDATE_EVENTS_GUEST_INFO_KEY,
            advertised_event_scopes_and_types_string,
            rpctool,
            rpctool_fn,
        )
        LOG.info(
        ...
        return advertised_event_scopes_and_types_string
