...
def network_manager_load_leases(
    device: str, dhcp6: bool = False
) -> Dict[str, str]:
    ...
    opts = ["--fields", opt_dhcp, "device", "show", device]
...
def network_manager_get_option_from_leases(
    keyname: str, device: Optional[str] = None, dhcp6: bool = False
) -> Optional[str]:
