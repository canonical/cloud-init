...
class _Annotator:
    ...
    def annotate(
        ...
        schema_deprecations: Tuple[Tuple[str, str], ...] = (),
    ) -> Union[str, bytes]:
...
# TODO make Tuple[Tuple[str, str], ...] an explicit type alias
def annotated_cloudconfig_file(
    ...
    # TODO check JSONSchemaValidationError
