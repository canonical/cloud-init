...
if metadata from a local source (e.g. nocloud, ovf) specifies a hostname
during the init stage. Some platforms require the hostname to be set for DHCP
to succeed; this behaviour ensures that it is.
