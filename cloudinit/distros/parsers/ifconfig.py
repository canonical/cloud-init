...
class Ifconfig:
    ...
    def parse(self, text: str) -> Dict[str, Ifstate]:
        ...
        # Return only name-keyed entries; MAC entries are available via
        # ifs_by_mac(). Merging both into one dict would require a
        # Union[Ifstate, List[Ifstate]] return type due to MAC entries
        # potentially mapping to multiple interfaces.
