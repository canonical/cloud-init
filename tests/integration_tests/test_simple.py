...
class TestSimple:
    ...
    def test_cloud_config(self, client):
        client.write_to_file('/home/ubuntu/my_test.txt', 'Hello world!')
        print(client.execute('cloud-init -v'))
        print(client.execute('cat /home/ubuntu/my_test.txt'))
        print(client.execute('cat /tmp/user_data.txt'))
        contents = client.read_from_file('/home/ubuntu/my_test.txt')
        print(contents)
...
class TestSingleInstance:
    ...
    def test_one(self, class_client):
        ...
        print(class_client.execute('cloud-init -v'))
