...
class TestDataSourceVultr(CiTestCase):
    ...
    @mock.patch("cloudinit.net.ephemeral.EphemeralDHCPv4.__init__", ephemeral_init)
    @mock.patch("cloudinit.net.ephemeral.EphemeralDHCPv4.__enter__", override_enter)
    @mock.patch("cloudinit.net.ephemeral.EphemeralDHCPv4.__exit__", override_exit)
    ...
    @mock.patch(
        "cloudinit.net.ephemeral.EphemeralDHCPv4.__init__", ephemeral_init_always
    )
    @mock.patch("cloudinit.net.ephemeral.EphemeralDHCPv4.__enter__", override_enter)
    @mock.patch("cloudinit.net.ephemeral.EphemeralDHCPv4.__exit__", override_exit)
    @mock.patch("cloudinit.sources.helpers.vultr.get_interface_list")
