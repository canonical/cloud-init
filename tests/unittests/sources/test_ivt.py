...
from cloudinit.sources import DataSourceIVT
...
class TestDataSourceIVT:
    ...
    def ds(self, paths, tmp_path):
        ...
        return DataSourceIVT.DataSourceIVT(settings.CFG_BUILTIN, distro, paths)

    @mock.patch("cloudinit.net.dhcp.maybe_perform_dhcp_discovery")
    @mock.patch("cloudinit.sources.DataSourceIVT.EphemeralDHCPv4")
    @mock.patch("cloudinit.net.find_fallback_nic")
    @mock.patch("cloudinit.sources.DataSourceIVT.read_metadata")
    @mock.patch("cloudinit.sources.DataSourceIVT.DataSourceIVT.ds_detect")
    def test_read_data(
        self,
        m_ds_detect,
        m_readmd,
    ...
    @mock.patch("cloudinit.net.find_fallback_nic")
    @mock.patch("cloudinit.sources.DataSourceIVT.DataSourceIVT.ds_detect")
    def test_not_on_ivt_returns_false(
    ...
    @mock.patch("cloudinit.sources.DataSourceIVT.get_interface_name")
