...
class TestGetMbrHddSize:
    def setUp(self):
        self.patches = ExitStack()
        self.subp = mock.patch.object(cc_disk_setup.subp, "subp")
    ...
    def _test_for_sector_size(self, sector_size):
        ...
        new_subp = self._configure_subp_mock(size_in_bytes, sector_size)
        with mock.patch.object(cc_disk_setup.subp, "subp") as subp:
            subp.side_effect = new_subp
