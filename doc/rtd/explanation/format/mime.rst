...
These scripts are written to their respective directories during the
:ref:`Network stage<boot-Network>` (when part handlers are processed) and
executed during cloud-init's :ref:`Final stage<boot-Final>` by the
